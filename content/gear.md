...
(hostname: `scarif`) as my personal daily driver.
...
- **Headphones:** [Audio Technica ATH-M50X][ath-m50x] and
  [Audio-Technica ATH-MSR7BK][ath-msr7bk] and AirPods Pro
- **Webcam:** [Logitech HD Pro Webcam C920][logitech]

## OS and Desktop Environment

I run [NixOS](https://nixos.org/). You can
[view my configs on GitHub](https://github.com/sumnerevans/nixos-configuration/).

I use [Dank Material Shell](https://danklinux.com/) on [Niri](https://niri-wm.github.io/niri/).

I use zsh, neovim, neomutt, and Firefox daily.

## Phone and Watch

I use a [Pixel 10](https://store.google.com/us/product/pixel_10) and a [Pebble 2 Duo](https://repebble.com/) as my daily drivers.

## Bags

- **Sling:** [Aer City Sling 2](https://aersf.com/products/city-sling-2)
- **EDC Backpack:** Aer City Pack
- **Travel Backpack:** [Aer Travel Pack 3](https://aersf.com/products/travel-pack-3) ---
  I use this for one-bagging trips.
- **Gym Bag:** [Aer Fit Pack 3](https://aersf.com/products/fit-pack-3)
- **Carry on:** [Aer Gym Duffel 3](https://aersf.com/products/gym-duffel-3) -- I use
  this when I two-bag a trip.

## Previous Computers

* **Desktop:** (hostname: `coruscant`) A custom-built desktop. See the
  [part list on PCPartPicker][partlist].

## Other Random Crap I Don't Use

If you want to buy any of these things, I might be open to selling them.

- **Monitor:** [Dell P2421D Monitor][dellp2421d] (2560×1440)
