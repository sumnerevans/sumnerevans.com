...
Today I competed in the ICPC Rocky Mountain Regionals at CSU. ICPC is the
International Collegiate Programming Contest. It's an algorithmic competition
for college students. I've competed in ICPC three times now, but today was is
the best my team has ever done. But I'm getting ahead of myself. Some background
on what we did.
...
placed **second**, and *((+)(((+)s)m)j)* (Sam Reinehr, Matt Baldin, and Joseph
...
than that, we finished **fourth-place regionally**!

Sam Reinehr's team went into the last hour with one problem left and managed to
finish it. They were able to do that and beat out *Utah Arches* (University of
...
- *The Open Sourcerers*, a team of all freshmen (Jake Vossen, Kieran Lewis, and
  Nick Redhorse) completed 4 problems for a middle-of-the-pack finish regionally
  and a top-ten finish on-location (at the time of this writing, full standings
  are not available).
...
All in all, the competition was a great success for both my team, Sam Reinehr's
team, and all of Mines. Sam and Jack were amazing teammates, and I'm really
proud of how well we worked together.
