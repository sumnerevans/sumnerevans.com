...
.. tip::
   ...
   explanation starting at around 11:25_ in the video.

   .. _11:25: https://youtu.be/tD3xvJF0kU0?t=685
...
.. raw:: html
    ...
    <iframe width="560"
            height="315"
            src="https://www.youtube.com/embed/tD3xvJF0kU0"
            frameborder="0"
            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
            allowfullscreen>
    </iframe>
...
solving it. There were two main factors that cause this problem to be difficult:

1. Solving the problem in the general case.
2. Solving the problem within the time limit.
...
2. Use recursion to generate possible times in-order. In this solution, the
   recursion would return a list of possibilities of the *rest* of the time
   string and the base-case would be a list of the possibilities for the
   right-most digit.
...
This problem is a simplified stack calculator. This problem is also trivial in
any LISP dialect, but LISP was not available as a language to submit solutions
