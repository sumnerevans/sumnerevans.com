...
#set document(
  ...
  date: datetime(year: 2018, month: 11, day: 14),
  extra: (
    categories: ("Hackathons",),
    tags: ("Facebook", "Travel", "San Francisco", "California"),
    build: (
...
#link("https://sumnerevans.com/portfolio/#project-datanium")[Datanium project]. Unfortunately, Robby
...
#link("https://sumnerevans.com../../school/2018-11-03-icpc/index.rst")[ICPC team].
...
#image("images/2018-11-14-facebook-hackathon-room.jpg", alt: "My huge room")
...
#image("images/2018-11-14-dinner.jpg", alt: "Dinner buffet served on the first day of the hackathon")
