...
#set document(
  ...
  date: datetime(year: 2018, month: 12, day: 18),
  extra: (
...
#link("https://medium.com/@yaron1m/hackathon-winning-secrets-3d2a41cacf9")[Hackathon Winning Secrets].
...
== Why You Should Listen to Me <posts-hackathons-how-to-win-a-hackathon-why-you-should-listen-to-me>

I have been to five hackathons and successfully created and demoed a project at
each of them. At the #link("https://sumnerevans.com/portfolio/#project-parqyng")[Xilinx] hackathon,
my team won the Grand Prize. At
#link("https://sumnerevans.com/portfolio/#project-blockmrs")[MinneHack 2018], we did not win
anything, but gained valuable experience. At
#link("https://sumnerevans.com/portfolio/#project-wii-track")[HackCU IV], we won Judges Favorite,
Best Use of AWS, and the Dish Network sponsor challenge. At
#link("https://sumnerevans.com/portfolio/#project-datanium")[MHacks], we won Best Use of GCP and the
Facebook Best Social Good Hack award. Most recently at the
#link("https://sumnerevans.com/portfolio/#project-hypar-map")[Global Hackathon Finals at Facebook],
we won First Place.
...
#link("https://sumnerevans.com/posts/hackathons/hackcu-v/")[HackCU V blog post].
...
#link("https://samsartor.com")[Sam Sartor]. Three of the hackathons (MinneHack, HackCU,
MHacks) I was on a team with #link("https://gitlab.com/robozman/")[Robby Zampino]. Two
of the hackathons (MinneHack, HackCU), I was on a team with
#link("https://david.florness.com/")[David Florness]. Two of the hackathons (HackCU,
Facebook), I was on a team with #link("https://gitlab.com/jhgarner")[Jack Garner]. Two
of the hackathons (Xilinx, MinneHack), I was on a team with
#link("https://jack.rosenth.al")[Jack Rosenthal]. Two of the hackathons (MHacks,
Facebook), I was on a team with
#link("https://gitlab.com/fisherdarling")[Fisher Darling]. One hackathon (Xilinx), I
was on a team with #link("https://github.com/daichij/")[Daichi Jameson]. Each of them
...
+ How to form a team for a hackathon.
+ How to prepare for a hackathon.
+ What to do at a hackathon.
+ Things to do during hackathon demos.
+ General tips.

== 1. How to Form a Team for a Hackathon <posts-hackathons-how-to-win-a-hackathon-1-how-to-form-a-team-for-a-hackathon>
...
== 2. How to Prepare for a Hackathon <posts-hackathons-how-to-win-a-hackathon-2-how-to-prepare-for-a-hackathon>
...
== 3. What to Do at a Hackathon <posts-hackathons-how-to-win-a-hackathon-3-what-to-do-at-a-hackathon>
...
== 4. Things to Do During Hackathon Demos <posts-hackathons-how-to-win-a-hackathon-4-things-to-do-during-hackathon-demos>
...
== 5. General Tips <posts-hackathons-how-to-win-a-hackathon-5-general-tips>
