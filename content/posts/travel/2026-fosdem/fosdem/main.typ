...
#set document(
  title: "FOSDEM 2026",
  description: "I attend FOSDEM 2026 and catch up with former Beeper coworkers, my friend Sam,\nand a bunch of Matrix-adjacent people.",
...
Since I'm no longer
#link("https://sumnerevans.com../../../life-updates/joining-canam/index.md")[working at Beeper],
...
Once I arrived in Brussels, I headed straight for #link("https://hsbxl.be/")[HSBXL] (an
open source hackerspace in Brussels) where there was a
#link("https://matrix.org/blog/2025/12/fosdem-presence/#friday-30th-january-community-hackathon-lounge-evening")[Matrix hackathon].
...
working with #link("https://henryhiles.com/")[Henry] on the
#link("https://git.federated.nexus/henry-hiles/nexus")[Nexus] client which is a Matrix
client that uses Flutter with the #link("https://github.com/gomuks/gomuks")[Gomuks] FFI
...
#link("https://samsartor.com/")[Sam] and #link("https://tgrcode.com/")[Addison] who had also
made the trip to FOSDEM from the states. Towards the end of the morning,
#link("https://mau.fi/")[Tulir] arrived and was actually helpful to Henry, since he
...
the
#link("https://fosdem.org/2026/schedule/track/browser-and-web-platform/")[Browser and web platform]
track.

The first talk I attended was about
#link("https://www.w3.org/TR/mathml-core/")[MathML Core] which is a cool way to encode
...
#link("https://www.linkedin.com/in/neil-johnson-717baa6/")[Neil] and caught up with
#link("https://github.com/harharlinks")[Kim]. I also caught up with Tulir and Tobias
...
#link("https://www.uhoreg.ca/")[Hubert Chathi]'s talk about DMLS. Messaging Layer
