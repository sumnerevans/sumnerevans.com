...
#set document(
  ...
  date: datetime(year: 2015, month: 8, day: 19),
  extra: (
...
#link("https://en.m.wikipedia.org/wiki/Globe_Theatre")[Wikipedia]). The Globe burned
...
Then we went to an exhibit called _The Making of the Modern World_.  Basically
