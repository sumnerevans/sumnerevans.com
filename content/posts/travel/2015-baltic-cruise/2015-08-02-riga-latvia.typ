...
#set document(
  title: "Riga, Latvia",
  date: datetime(year: 2015, month: 8, day: 2),
  extra: (
...
+ Like Estonia, Latvia was occupied many times by various forces. It started
  with the Soviets, then the Nazis and then the Soviets again.
+ Before the Nazis occupied Latvia, 70,000 Jews lived in Latvia.  Within a few
...
+ There was an exhibit where they displayed various examples of graffiti art
