...
#set document(
  ...
  date: datetime(year: 2015, month: 8, day: 18),
  extra: (
...
#image("images/york1.jpg", alt: "My chicken and mushroom pie.")
...
#image("images/york2.jpg", alt: "The reconstruction of a town street from the 1800s")
