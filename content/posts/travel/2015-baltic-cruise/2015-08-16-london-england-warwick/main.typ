...
#set document(
  ...
  date: datetime(year: 2015, month: 8, day: 16),
  extra: (
...
#image("images/warwick1.jpg", alt: "View of a lush garden area from the top of Warwick Castle")

#image("images/warwick2.jpg", alt: "View of the Warwick skyline from the top of Warwick Castle")
