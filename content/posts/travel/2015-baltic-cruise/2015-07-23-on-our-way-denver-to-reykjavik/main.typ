...
#set document(
  ...
  date: datetime(year: 2015, month: 7, day: 23),
  extra: (
...
(#strong[Lu]nch/Su#strong[pper]) at Panda Express. We are currently somewhere over the US
...
I now have some 7-up. Hannah is watching _The Hobbit: Battle of the Five Armies_
...
#image("images/mom-hannah-plane1.jpg", alt: "Mom and Hannah Sleeping on the Plane")
...
_Note: unless otherwise stated, all times are in military/24 hr time with either
the 3 character timezone code or the city name._
