...
#set document(
  ...
  date: datetime(year: 2015, month: 8, day: 10),
  extra: (
    categories: ("Baltic Cruise and Northern Europe",),
    tags: ("England", "London", "St. Paul's Cathedral"),
  ),
)
#show: page-template
...
+ The dome is 365ft (111.25 metres) high. This is no coincidence. Sir
  Christopher Wren intentionally created the dome with 1ft per day of the
  year.
+ There are two domes that make up the impressive interior of the dome. From
...
+ The architect of St. Paul's, Sir Christopher Wren, did not take the
...
+ St. Paul's was the only cathedral of the period to be completed in the
  architect's lifetime. It took only 32 years to construct the building, a
  very short period for the time.
+ St. Paul's became a symbol of the resilience of London during WWII. Winston
  ...
  whatever they hit.
+ General Cornwallis, the one who surrendered in Yorktown, has a monument in
...
+ At the entrance to the church, there is a baptism pool/fountain thing. (I'm
...
+ The church was originally constructed with a relatively simple interior.
  ...
  rebuilt the quire.
+ The Anglican Church is neither Catholic or protestant. There are no ties to
...
overwhelming museum; there is _so_ much to see. We used Rick Steve's audio tour
...
Parthenon in Athens. When we were in Athens (you can read about that in #link("https://sumnerevans.com../2012-transatlantic-cruise/day-24-athens-greece.md")[my post
from last trip]), we saw the Parthenon museum where they have casts of the stones that are
