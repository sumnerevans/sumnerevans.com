...
#set document(
  ...
  date: datetime(year: 2015, month: 8, day: 5),
  extra: (
...
+ There was a square which had a Catholic cathedral at one corner.
...
+ In another square there was a Lutheran cathedral that looks very similar to
...
+ German Chancellor Angela Merkel's apartment is just across the street from
...
+ Any building in Berlin that does not have bullet hole damage was either not
  ...
  war.
+ When the Nazis took over Germany in 1933, a demonstration was held and
...
+ We were able to go see the Brandenburg Gate where Regan made his famous
...
+ Towards the end of our tour we went to the Memorial to the Murdered Jews of
  Europe. When I was inside the memorial, the scale of the monument made the
  extent of the horror that was the Holocaust.

  #image("images/berlin1.jpg", alt: "Memorial to the Murdered Jews of Europe")

+ We rode past the various embassies, the German Parliament, and the German
