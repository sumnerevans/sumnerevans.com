...
#set document(
  ...
  date: datetime(year: 2015, month: 7, day: 27),
  extra: (
...
We rode the \#1 bus into town and stopped at the _Cityterminalen_ (the main
train station), the same stop we (accidentally) went to yesterday.  Then we
wandered around trying to find the dock for the _Historical City Boat Tour_. We
...
to the bus stop for bus 76 to _Frihamnen_ (the cruse port). This time, the bus
...
#html.blockquote[
_"What do you call a person who can speak two languages?":_ "bilingual"

_"What do you call a person who can speak three languages?":_ "trilingual"

_"What do you call a person who can speak only one language?":_ "an American"
