...
#set document(
  ...
  date: datetime(year: 2015, month: 8, day: 7),
  extra: (
...
+ We went to the Queen's palace and took some pictures. I'm sure it is
  interesting to someone, but I didn't. It was pretty, but I've seen so many
  pretty buildings lately.
+ We went to the sculpture of the Little Mermaid. It is very little.  I'm not
  sure what the fuss is about it, but it’s apparently the \#1 thing to see in
  Copenhagen so now it's checked off my todo list.
+ We went through some really pretty streets and got to know the town better.
+ At one point, we stopped in front of an art museum (that's where the picture
