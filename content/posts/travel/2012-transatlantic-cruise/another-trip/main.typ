...
#set document(
  title: "Another Trip!",
  date: datetime(year: 2012, month: 4, day: 22),
  extra: (
...
#link("http://www.hollandamerica.com/find-cruise-vacation/CruiseDetails.action?destCode=E&portCode=FLL&shipCodeSearch=NO&durationCode=4&dateCode=&flexibleMonths=false&noOfFlexibleMonths=1&pageNumber=1&voyageCode=N231A&webItineraryIdForAudit=ETS226")[here].

Here is a map of where we are going:

#image("./images/cruiseIteneraryMap.jpg", alt: "Itinerary")
