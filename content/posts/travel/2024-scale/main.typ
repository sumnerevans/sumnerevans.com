...
#set document(
  ...
  description: "I attended SCaLE for the first time this year and participated in the\nco-located NixCon.\n",
  date: datetime(year: 2024, month: 3, day: 17),
  extra: (
    categories: ("Travel", "Conferences"),
    tags: ("NixCon", "SCaLE", "Pasadena", "California", "Nix", "NixOS", "Home Manager", "Immutability"),
...
year. I went with my friend #link("https://tgrcode.com")[Addison], and while I was
...
#image("images/nix-banner.jpg", alt: "The Nix standard")
...
on #link("https://nix-community.github.io/home-manager/")[Nix Home Manager]. I'm a
...
out, I ran into #link("https://www.linkedin.com/in/josh-hoffer/")[Josh Hoffer] who I
...
#link("https://www.linkedin.com/in/johnrichardrinehart/")[John Rinehart] and we caught
...
tacos. #link("https://nicfv.com/")[Nicolas (Nic)] works at
#link("https://www.nersc.gov/")[NERSC] at the Berkeley National Laboratory, and
#link("https://www.nathanieljwright.com/")[Nathan] and Tony work on database software
at #link("https://www.aveva.com")[AVEVA]. There were a couple other people in the
...
#link("https://github.com/ElvishJerricco")[Will Fancher]'s talk about using systemd in
...
The next talk was by #link("https://blog.tiserbox.com/")[Pierre Penninckx] about module
...
#link("https://www.achille.fyi/")[Achille Verheye] about an
#link("https://open-source-rover.readthedocs.io/en/latest/")[open-source rover hardware project]
...
#link("https://www.linkedin.com/in/ninakin/")[Nina Kin] about transit data. She talked
...
myself went over to #link("https://maps.app.goo.gl/QJAAJ6unST2h7fnG9")[King Taco] for
lunch.
...
Nathan for burgers at #link("https://maps.app.goo.gl/zpwhX8zEhned77UT7")[The Stand].
...
#image("images/skating.jpg", alt: "Nathan, Nic, Addison and myself ice skating")
...
#link("https://www.linkedin.com/in/jonathan-schatz-0214ba252/")[Jon], who lives in
...
#link("https://maps.app.goo.gl/Mohdkub9TAWqMEXY6")[Crazy Rock'n Sushi] and then walked
...
#link("https://github.com/edolstra")[Eelco Dolstra] (whose PhD dissertation is the
...
Nixpkgs committers (#link("https://nichi.co/")[Nick Cao] and
#link("https://siraben.dev/")[Ben Siraphob]) and some students who came up by train
from San Diego. Ben is getting his PhD at Yale and actually works in an adjacent
research group to
#link("https://www.linkedin.com/in/jordan-schmerge/")[Jordan Schmerge] who I know from
...
my friend #link("https://ethancranston.com/")[Ethan Cranston] who I'd come to see in LA
#link("https://sumnerevans.com../2023-los-angeles/index.md")[last year]. Ethan works at SpaceX, and
...
#link("https://sumnerevans.com../2022-berlin-matrix-summit/summit/index.md")[Berlin Matrix Summit]
