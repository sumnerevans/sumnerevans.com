...
#set document(
  ...
  description: "Today I travelled via the Chunnel to London and visited an exhibit at the\nBritish Museum. Then I travelled home via Lisbon and Munich.\n",
  date: datetime(year: 2022, month: 6, day: 19),
  extra: (
...
tunnel, but it was very cool to go _under an ocean_ in a train!
...
bags up at the luggage storage location (the name was #link("https://kingscrossluggage.co.uk/")[Kings Cross Luggage
Storage] and it was super convenient). Then I
...
home. After the
#link("https://sumnerevans.com../ericeira-portugal/index.md")[retreat]
