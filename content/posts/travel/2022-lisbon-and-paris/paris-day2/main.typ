...
#set document(
  ...
  description: "Today I took a day-trip to the Normandy beaches. It was a very moving\nexperience, and it made me even more grateful for the sacrifices of the\nGreatest Generation during the war.\n",
  date: datetime(year: 2022, month: 6, day: 16),
  extra: (
    categories: ("Trip to Portugal and France",),
    tags: ("Travel", "Paris", "France", "Normandy"),
...
A few years ago, I
#link("https://sumnerevans.com../../2019-dc-transatlantic-cruise/2019-05-24-2019-05-31-queen-mary-2-crossing/index.rst#wwii-veteran-presentations")[had the pleasure of hearing from D-Day veterans]
...
#html.blockquote[
Seventy-five years apart, we came to Normandy.#html.elem("br") Two different
circumstances: one to liberate, one to commemorate.#html.elem("br") Yet here be the same
waters, the same sand, the same hills, the same fields.#html.elem("br") The tides come
and go; the forces of creation are constant.#html.elem("br") Oh how fleeting are the
forces of men.
...
#image("images/veteran1.jpg")



#image("images/veteran2.jpg")
...
#image("images/juno.jpg", alt: "Defensive works at Juno beach")
