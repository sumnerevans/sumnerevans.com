...
#set document(
  title: "FOSDEM 2025",
  description: "For the third year in a row, I attended FOSDEM. I attended the Matrix\ncommunity meetup as well as many talks at the main conference.\n",
  date: datetime(year: 2025, month: 2, day: 2),
  extra: (
    categories: ("Travel", "Conferences"),
    tags: ("FOSDEM", "Matrix", "HSBXL", "Go (Programming Language)", "Brussels", "Belgium"),
...
For the third year in a row, I attended #link("https://fosdem.org/2025/")[FOSDEM], a
Free and Open Source Software conference. I enjoyed the previous
#link("https://sumnerevans.com../../2023-fosdem/fosdem/index.md")[two]
#link("https://sumnerevans.com../../2024-fosdem/fosdem/index.md")[years], and Automattic paid for
...
(probably second only to the #link("https://2024.matrix.org/")[Matrix Conference]), and
there is also a sizeable Go presence at the conference as well.

This year, both Brad and #link("https://mau.fi/")[Tulir] attended from Beeper, and even
more from the wider Automattic company.

== Matrix Community Meetup <posts-travel-2025-fosdem-fosdem-matrix-community-meetup>

/* TODO twyla-convert: hugo shortcode: figure src=&quot;images/matrix.jpg&quot; title=&quot;The Matrix Community Meetup&quot; */
...
#link("https://samsartor.com/")[Sam] and Aiden from Colorado also attended.

I had good conversations with many community members throughout the afternoon
and evening. #link("https://www.linkedin.com/in/yncyrydybyl/")[Yan] and
#link("https://github.com/harharlinks")[Kim] once again did a fantastic job organizing
...
== Go Dev Room <posts-travel-2025-fosdem-fosdem-go-dev-room>
...
+ Given a hash, there are three levels of associativity. The first 2 bits of
...
+ When trying to determine if a key matches, every element in the metadata
...
== Finding More Matrix Folks <posts-travel-2025-fosdem-fosdem-finding-more-matrix-folks>
...
== Matrix Booth and Devroom <posts-travel-2025-fosdem-fosdem-matrix-booth-and-devroom>
...
#link("https://github.com/kegsay")[Kegan] is doing to test federation. Another
highlight was #link("https://github.com/erikjohnston")[Erik]'s talk about the state of
...
#link("https://github.com/kevinaboos")[Kevin]'s presentation about Robrix which is a
