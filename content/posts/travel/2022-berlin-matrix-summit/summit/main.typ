...
#set document(
  ...
  description: "The Berlin Matrix Community Summit was the first Matrix-only event. Hosted in\nBerlin, it was an action-packed meeting of many of the greatest Matrix-minds.\n",
  date: datetime(year: 2022, month: 8, day: 28),
  extra: (
    categories: ("Berlin Matrix Community Summit 2022", "Conferences"),
    tags: ("Travel", "Berlin", "Germany", "Matrix", "Matrix Community Summit"),
...
= Barcamp <posts-travel-2022-berlin-matrix-summit-summit-barcamp>

On Thursday we had a #link("https://en.wikipedia.org/wiki/BarCamp")[barcamp] which
...
= Talks and Workshops <posts-travel-2022-berlin-matrix-summit-summit-talks-and-workshops>
...
- *Ben's Rust SDK talk*
  ...
  #image("images/rust-sdk.jpg", alt: "Ben presenting the new Matrix Rust SDK")
...
= Presentation Time! <posts-travel-2022-berlin-matrix-summit-summit-presentation-time>

In addition to attending many talks and workshops, I gave a few as as well. On
Friday, I gave a \[presentation about Hungryserv\](/* TODO twyla-convert: hugo shortcode: ref
...
On Saturday, I gave a presentation about \[what Beeper is working on\](/* TODO twyla-convert: hugo shortcode: ref
...
Python. He presented
#link("https://github.com/i10b/simplematrixbotlib/")[simplematrixbotlib] and I
presented #link("https://github.com/maubot/maubot")[maubot]. Then we gave participants
...
= The Hallway Track <posts-travel-2022-berlin-matrix-summit-summit-the-hallway-track>
...
== Lange Nacht der Museen <posts-travel-2022-berlin-matrix-summit-summit-lange-nacht-der-museen>
...
#html.elem("figure")[#html.elem("table", attrs: ("class": "gallery"))[#html.elem("tbody")[#html.elem("tr")[#html.elem("td", attrs: ("width": "35%"))[]]]]]

#image("images/cray.jpg")
...
= Conclusion <posts-travel-2022-berlin-matrix-summit-summit-conclusion>
