...
#set document(
  ...
  description: "Today I had to leave the beautiful city of Berlin to head back home from the\nMatrix Community Summit.",
  date: datetime(year: 2022, month: 8, day: 29),
  extra: (
...
#link("https://sumnerevans.com../../2022-lisbon-and-paris/london-back-home/index.md")[coming back from Lisbon],
