...
#set document(
  title: "FOSDEM 2023",
  description: "I attended FOSDEM for the first time this year and I had a blast!\nI enjoyed attending many talks, but the best part was getting to meet so many\ncool people.\n",
  date: datetime(year: 2023, month: 2, day: 5),
  extra: (
    categories: ("Travel", "Conferences"),
    tags: ("FOSDEM", "Matrix Community Meetup", "HSBXL", "Matrix", "Go", "NixOS", "Brussels", "Belgium"),
...
year. My employer, #link("https://beeper.com")[Beeper], funded my flight, and I decided
...
#link("https://sumnerevans.com../../2022-berlin-matrix-summit/summit/index.md")[Matrix Community Summit in Berlin last year]
and meet a bunch new people as well.

== The Matrix Community Meetup <posts-travel-2023-fosdem-fosdem-the-matrix-community-meetup>
...
#link("https://www.linkedin.com/in/yncyrydybyl/")[Yan] (who was one of the organizers
of the Berlin summit) and #link("https://github.com/harharlinks")[Kim] (who attended
the Berlin summit) did a great job organizing the meetup.
#link("https://www.famedly.com/")[Famedly] and #link("https://nordeck.net/")[Nordeck]
...
One of the discussions that I took part in was about #link("https://github.com/matrix-org/matrix-spec-proposals/pull/3575")[sliding
sync] which is a
proposal for a new way to sync data from Matrix servers to Matrix clients.
#link("https://www.linkedin.com/in/kegan-dougal-218b3830/")[Kegan] is the main
...
#link("https://github.com/mtrnord")[Marcel], #link("https://github.com/timokoesters")[Timo],
#link("https://github.com/anoadragon453")[Andrew], and
#link("https://www.linkedin.com/in/benparsons/")[Ben] in-person because they are very
active in the community and I'd only ever interacted with them online. I was
also happy to reconnect with #link("https://neko.dev/")[Nico], Kim, Yan,
#link("https://chrpaul.de/")[Christian], #link("https://nwex.de/")[networkException], Shine,
...
== It's Go Time! <posts-travel-2023-fosdem-fosdem-its-go-time>
...
#link("https://sumnerevans.com../../../programming/2022-advent-of-code/index.md")[did last year's Advent of Code in Go].
...
being able to wrap _any_ errors, so I am going to definitely have to look into
...
#link("https://codeberg.org/DerLukas/goolm")[go-olm].
...
about how to use _string interning_ to reduce memory usage of Go programs. The
...
wearing a #link("https://changelog.com/gotime")[Go Time podcast] t-shirt and realized
...
#link("https://fosdem.org/2023/schedule/speaker/ronna_steinberg/")[Ronna Steinberg]
...
#link("https://www.arionbrussels.be/en/the-brasserie-belgian-cuisine/")[Arion], a
...
#link("https://dandellion.xyz/")[Daniel] who is a fellow Matrix and NixOS enthusiast.
...
such as the #link("https://github.com/matrix-org/complement")[complement test suite].
...
== Entering the Matrix <posts-travel-2023-fosdem-fosdem-entering-the-matrix>
...
#image("images/matrixdevroom.jpg", alt: "Matthew and Amandine talking about Matrix adoption")
...
== NixOS <posts-travel-2023-fosdem-fosdem-nixos>
...
I was also especially excited to hear the talk by #link("https://www.domenkozar.com/")[Domen
Kožar] about #link("https://devenv.sh/")[direnv.sh] which
...
== Matrix 2.0 <posts-travel-2023-fosdem-fosdem-matrix-20>

Late in the afternoon in the main auditorium, Matthew presented a talk titled
_Matrix 2.0_ (not related to the spec version) in which he described the active
...
== See you next time! <posts-travel-2023-fosdem-fosdem-see-you-next-time>
...
As far as the vision that Matthew laid out in his _Matrix 2.0_ talk, I'm most
