...
#set document(
  ...
  date: datetime(year: 2021, month: 9, day: 10),
  extra: (
...
#html.elem("video", attrs: ("src": "./images/side-kick-washington.mp4", "width": "50%", "class": "align-center", "autoplay": "true", "controls": "true", "muted": "true", "loop": "true"))[
]
