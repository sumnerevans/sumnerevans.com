...
#set document(
  ...
  description: "I went to visit my friend, Nic, who is a photojournalist reporting on SpaceX's\nStarbase facility in Texas.\n",
  date: datetime(year: 2022, month: 10, day: 24),
  extra: (
    categories: ("Travel",),
    tags: ("Travel", "Starbase", "Texas"),
...
#link("https://sumnerevans.com../2022-mexico-city-retreat/index.md")[work retreat in Mexico City],
...
#link("https://nasaspaceflight.com")[nasaspaceflight.com] and reports on the
