...
#set document(
  ...
  date: datetime(year: 2017, month: 12, day: 30),
  extra: (
...
at the _natural bridge_. Or rather, the former location of the natural bridge.
...
#html.elem("table", attrs: ("width": "100%"))[#html.elem("tbody")[#html.elem("tr")[#html.elem("td", attrs: ("width": "50%"))[]]]]

#image("images/aruba1.jpg")
