...
#set document(
  title: "Half Moon Cay",
  date: datetime(year: 2017, month: 12, day: 28),
  extra: (
...
garden. One interesting plant was the _Seven-Year Apple_ which produces apples
...
_very_ good and was extremely fast with his fingers.
