...
transatlantic cruise to Europe (see #link("/categories/transatlantic-cruise-and-europe")[Transatlantic
Cruise]).
...
We then went over to _BILLBOARD on Board_ where two pianists play hits from the
