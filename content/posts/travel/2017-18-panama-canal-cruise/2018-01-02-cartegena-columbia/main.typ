...
#set document(
  ...
  date: datetime(year: 2018, month: 1, day: 2),
  extra: (
...
stop was at the main fortress: _Castillo San Felipe de Barajas_.

#image("images/cartegena-1.jpg", alt: "Castillo San Felipe de Barajas")
...
fighting condition and lost the _Battle for Cartegena de Indias_.

#image("images/cartegena-2.jpg", alt: "Blas de Lezo")

After getting a look at the fortress, we drove to the _Convento de la Popa_, the
primary monastery in Cartegena. From this monastery, we had a panoramic view of
the entire city.

#image("images/cartegena-3.jpg", alt: "Panorama from the \"La Popa\" Monastery")
...
This evening's show was the _Island Magic Steelband_, a steelband from Trinidad
