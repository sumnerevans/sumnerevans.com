...
#set document(
  ...
  description: "Today I went to visit the Van Gogh Museum in the morning, and the Anne Frank\nHouse late in the evening. In between, I walked around the city, and met up\nwith my coworkers for dinner.\n",
  date: datetime(year: 2023, month: 3, day: 24),
  extra: (
    categories: ("Travel", "Trip to Amsterdam"),
...
One of the reasons I chose the hotel that I did was that it was a _very_ short
...
I was especially struck by the painting _Fishing Boats on the Beach at Les
Saintes-Maries-de-la-Mer_. I don't know exactly why I like it; maybe it is the
...
#link("https://sumnerevans.com../retreat/index.md")[work retreat]
