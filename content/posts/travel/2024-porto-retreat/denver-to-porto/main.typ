...
#set document(
  ...
  description: "I once again made a trip across the pond, this time for work. I'm attending a\nteam meetup in Porto, Portugal.\n",
  date: datetime(year: 2024, month: 4, day: 21),
  extra: (
    categories: ("Travel",),
    tags: ("Denver", "Porto", "Portugal", "Automattic", "Beeper"),
    build: (
...
attending a #link("https://sumnerevans.com../retreat/index.md")[team meetup] in Porto, Portugal.

I ran the
#link("https://sumnerevans.com/posts/school/2024-hspc/")[2024 Mines High School Programming Competition]
...
#link("https://maps.app.goo.gl/iV4TEZbwPHL2jhax6")[Boeira Garden Hotel Porto Gaia].
