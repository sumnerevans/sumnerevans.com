...
#set document(
  ...
  description: "After the work retreat, I stayed in Porto an extra day to sightsee.\n",
...
On the Saturday after the #link("https://sumnerevans.com../retreat/index.md")[retreat] I did my
own sightseeing and adventuring around Porto. However, as I mentioned in my
#link("https://sumnerevans.com../retreat/index.md#walking-tour")[post about the retreat], a
...
== Walking Tour <posts-travel-2024-porto-retreat-porto-sightseeing-walking-tour>
...
#link("https://sumnerevans.com../../2022-lisbon-and-paris/lisbon-day2/index.md")[when I was there a few years ago]).
...
#image("images/mural.jpg", alt: "One of the train station murals")
...
#image("images/justice.jpg", alt: "Lady Justice with some authoritarian modifications")

Along the walking tour, we walked along many pretty streets. This one in
particular caught my eye for its vibrant colours:

#image("images/houses.jpg", alt: "Very colourful houses")

== Cleric's Tower <posts-travel-2024-porto-retreat-porto-sightseeing-clerics-tower>

On Saturday, after the retreat was over, I spent the day sightseeing. A was
staying at #link("https://maps.app.goo.gl/f5UmwULLZHZtKhk97")[_Residencial Bragança_]
...
#image("images/view.jpg", alt: "The view of Porto from the Cleric's tower")
...
#image("images/tower.jpg", alt: "The Cleric's Tower with the tram out front")
...
#image("images/narrow-street.jpg")

*A view down a narrow street in Porto*



#image("images/colourful-street.jpg")
...
#image("images/restaurant-view.jpg", alt: "The view from the restaurant I went to for dinner")
