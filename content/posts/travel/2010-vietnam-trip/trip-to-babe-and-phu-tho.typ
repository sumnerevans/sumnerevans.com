...
#set document(
  ...
  date: datetime(year: 2010, month: 11, day: 19),
  extra: (
...
== \~Hannah\~ <posts-travel-2010-vietnam-trip-trip-to-babe-and-phu-tho-hannah>
...
was just \
_asking for directions._ After a LONG time we finally arrived at our
...
AND They were _So_ fascinated by my braces(not surprised though.). For
...
another 3 hours we #html.elem("u")[_*FINALLY*_] arrived in Phu Tho province. We
...
#html.elem("div", attrs: ("style": "text-align: center;"))[]
...
_When you are tired of a dirty old hotel,_
...
_and A pretty nice view, but I'm telling you, you'll not see any
pelicans_
