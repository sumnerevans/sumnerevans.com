...
#set document(
  ...
  date: datetime(year: 2010, month: 11, day: 30),
  extra: (
...
#html.elem("h2", attrs: ("style": "font-family: Georgia, \"Times New Roman\", serif;"))[]

\~Hannah\~



#html.elem("div", attrs: ("style": "font-family: Georgia, \"Times New Roman\", serif;"))[]
