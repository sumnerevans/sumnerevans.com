...
#set document(
  ...
  date: datetime(year: 2010, month: 11, day: 29),
  extra: (
...
== Sumner <posts-travel-2010-vietnam-trip-twenty-eight-day-hoi-112910-sumner>
...
The entire meal was _delicious_! Then we chatted for a while until about
