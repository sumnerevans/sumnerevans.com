...
#set document(
  title: "FOSDEM 2024",
  description: "For the second year in a row, I attended FOSDEM. I attended the Matrix\ncommunity meetup as well as many talks at the main conference.\n",
  date: datetime(year: 2024, month: 2, day: 5),
  extra: (
    categories: ("Travel", "Conferences"),
    tags: ("FOSDEM", "Matrix", "HSBXL", "Go (Programming Language)", "Nix", "NixOS", "Brussels", "Belgium"),
...
Software conference. I \[attended last year as well\](/* TODO twyla-convert: hugo shortcode: ref
...
== Matrix Community Meetup <posts-travel-2024-fosdem-fosdem-matrix-community-meetup>
...
people as well. #link("https://www.linkedin.com/in/yncyrydybyl/")[Yan] and
...
#link("https://github.com/travisr")[Travis Ralston] who is a spec core team member and
#link("https://github.com/half-shot")[Will Hunt (half-shot)] who works on bridges at
...
#link("https://www.linkedin.com/in/benparsons/")[Ben],
#link("https://github.com/mtrnord")[Marcel], #link("https://neko.dev/")[Nico],
#link("https://chrpaul.de/")[Christian], Jan, and many others.

A bunch of people trickled in to the event throughout the afternoon and evening,
including my coworker #link("https://mau.fi/")[Tulir]. Eventually, pizza came,
sponsored by #link("https://nordeck.net/")[Nordeck] and
#link("https://www.famedly.com/")[Famedly], and great conversations continued
...
== Go Devroom <posts-travel-2024-fosdem-fosdem-go-devroom>
...
#link("https://github.com/DerLukas15")[\@DerLukas15]. It was a very good talk, and
...
== Some Other Talks <posts-travel-2024-fosdem-fosdem-some-other-talks>
...
== Focused on Matrix <posts-travel-2024-fosdem-fosdem-focused-on-matrix>
