...
#set document(
  ...
  description: "Today I went to Waterloo, the town where Napoleon was defeated by the Seventh\nCoalition.\n",
  date: datetime(year: 2024, month: 2, day: 6),
  extra: (
    categories: ("Travel",),
    tags: ("Waterloo", "Belgium", "Museum", "Wellington", "Napoleon", "Battlefield"),
...
#image("images/church.jpg", alt: "Some of the plaques commemorating the soldiers who died during the Battle of Waterloo")
...
#image("images/wellington.jpg", alt: "The Wellington Museum")
