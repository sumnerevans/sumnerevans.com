...
#set document(
  ...
  date: datetime(year: 2018, month: 7, day: 7),
  draft: true,
  extra: (
    category: ("Politics",),
...
= What Is Net Neutrality? <posts-politics-conservatives-net-neutrality-what-is-net-neutrality>
...
== Conceptual Level <posts-politics-conservatives-net-neutrality-conceptual-level>

So, what is Net Neutrality at a conceptual level? *It is the idea that all
traffic on the Internet should be treated equally*#link("https://en.wikipedia.org/wiki/Net_neutrality")[^1]. What does this entail
in practice?

=== It does _not_ mean _equal speed_ <posts-politics-conservatives-net-neutrality-it-does-not-mean-equal-speed>
...
=== It _does_ prevent throttling or speeding up _certain data_ <posts-politics-conservatives-net-neutrality-it-does-prevent-throttling-or-speeding-up-certain-data>
...
== Policy Level <posts-politics-conservatives-net-neutrality-policy-level>
...
communications by radio, television, wire, satellite, and cable #link("https://en.wikipedia.org/wiki/Federal_Communications_Commission")[^2]. This
...
== Political Level <posts-politics-conservatives-net-neutrality-political-level>
...
+ *Republicans are against anything done in the Obama-era regardless of
...
+ *Republicans talk about Net Neutrality as a regulation.* Because of this
...
+ *Democrats herald Net Neutrality as an Obama victory*. This fires up the
...
+ *Democrats don't explain the policy well.* Most of the politicians talking
  about Net Neutrality have no idea how the Internet works.

  .. TODO: example

+ *Democrats make it about "evil corporations" which hurts their case with
  Conservatives.* What we really need to be talking about here is anti-trust
  laws which have broad bipartisan support.

.. TODO: lobyists

= What Is the Conservative Case? <posts-politics-conservatives-net-neutrality-what-is-the-conservative-case>
...
= References <posts-politics-conservatives-net-neutrality-references>
