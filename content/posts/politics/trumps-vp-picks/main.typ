...
#set document(
  ...
  description: "Both times Donald Trump had to make a pick for Vice President he made the\nperfect decision.\n",
  date: datetime(year: 2025, month: 6, day: 1),
  extra: (
    categories: ("Politics",),
    tags: ("Donald Trump", "Vice President", "Mike Pence", "JD Vance"),
    build: (
...
== 2016: Mike Pence <posts-politics-trumps-vp-picks-2016-mike-pence>
...
== 2024: JD Vance <posts-politics-trumps-vp-picks-2024-jd-vance>
