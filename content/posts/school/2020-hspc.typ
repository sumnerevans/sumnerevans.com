...
#set document(
  ...
  date: datetime(year: 2020, month: 4, day: 25),
  extra: (
    categories: ("School",),
...
#link("https://sumnerevans.com/posts/school/2019-hspc/")[this post]. This year, although I am no
...
== Competition Highlights <posts-school-2020-hspc-competition-highlights>
...
== The Problems <posts-school-2020-hspc-the-problems>
...
=== A - Flatter Land <posts-school-2020-hspc-a-flatter-land>
...
/* TODO twyla-convert: hugo shortcode: youtube id=&quot;WnW_XFnU3KM&quot; title=&quot;Mines HSPC 2020 Problem A: Flatter Land Solution and Explanation&quot; */

#html.elem("details", attrs: ("class": "youtube-expander"))[#html.elem("summary")[Mines HSPC 2020 Problem A: Flatter Land Solution and Explanation]]

=== H - Work From Home <posts-school-2020-hspc-h-work-from-home>
...
/* TODO twyla-convert: hugo shortcode: youtube id=&quot;Otau4U8M6Kk&quot; title=&quot;Mines HSPC 2020 Problem H: Work From Home Solution and Explanation&quot; */

#html.elem("details", attrs: ("class": "youtube-expander"))[#html.elem("summary")[Mines HSPC 2020 Problem H: Work From Home Solution and Explanation]]

=== F - Late Larry <posts-school-2020-hspc-f-late-larry>
...
explanation starting at around #link("https://youtu.be/z6uFZfZ5GWI?t=687")[11:27] in
the video.

]

/* TODO twyla-convert: hugo shortcode: youtube id=&quot;z6uFZfZ5GWI&quot; title=&quot;Mines HSPC 2020 Problem F: Late Larry Solution and Explanation&quot; */

#html.elem("details", attrs: ("class": "youtube-expander"))[#html.elem("summary")[Mines HSPC 2020 Problem F: Late Larry Solution and Explanation]]

=== I - Skittles <posts-school-2020-hspc-i-skittles>
...
+ Determine the number of Skittles of each flavour that are in the bag. This is
...
+ Determine how many batches of each size can be eaten. One way to do this is
...
/* TODO twyla-convert: hugo shortcode: youtube id=&quot;nscAF6-Q-Mo&quot; title=&quot;Mines HSPC 2020 Problem I: Skittles Solution and Explanation&quot; */

#html.elem("details", attrs: ("class": "youtube-expander"))[#html.elem("summary")[Mines HSPC 2020 Problem I: Skittles Solution and Explanation]]

=== C - CDOT Pathfinder <posts-school-2020-hspc-c-cdot-pathfinder>
...
/* TODO twyla-convert: hugo shortcode: youtube id=&quot;lTcAA0ohT_g&quot; title=&quot;Mines HSPC 2020 Problem C: CDOT Pathfinder Solution and Explanation&quot; */

#html.elem("details", attrs: ("class": "youtube-expander"))[#html.elem("summary")[Mines HSPC 2020 Problem C: CDOT Pathfinder Solution and Explanation]]

=== K - Snails <posts-school-2020-hspc-k-snails>
...
#link("https://en.wikipedia.org/wiki/Memoization")[_memoize_] (not a misspelling) the
...
/* TODO twyla-convert: hugo shortcode: youtube id=&quot;qt4L7XYMEqY&quot; title=&quot;Mines HSPC 2020 Problem K: Snails Solution and Explanation&quot; */

#html.elem("details", attrs: ("class": "youtube-expander"))[#html.elem("summary")[Mines HSPC 2020 Problem K: Snails Solution and Explanation]]

=== J - Mountain Bike Trail <posts-school-2020-hspc-j-mountain-bike-trail>
...
=== L - Magic Maze <posts-school-2020-hspc-l-magic-maze>
...
=== E - Encrypted Counting <posts-school-2020-hspc-e-encrypted-counting>
...
#link("https://en.wikipedia.org/wiki/Look-and-say_sequence")[_look-and-say_]
...
version of the
#link("https://en.wikipedia.org/wiki/Run-length_encoding")[_run-length encoding_]
encoding problem.
...
=== D - Paint Bucket <posts-school-2020-hspc-d-paint-bucket>
...
#link("https://en.wikipedia.org/wiki/Flood_fill")[_flood fill_] algorithm to determine
which cells to colour in. A flood fill algorithm is similar to a
#link("https://en.wikipedia.org/wiki/Breadth-first_search")[BFS] or
#link("https://en.wikipedia.org/wiki/Depth-first_search")[DFS], but instead of
...
/* TODO twyla-convert: hugo shortcode: youtube id=&quot;VOOLq6ed0wI&quot; title=&quot;Mines HSPC 2020 Problem D: Paint Bucket Solution and Explanation&quot; */

#html.elem("details", attrs: ("class": "youtube-expander"))[#html.elem("summary")[Mines HSPC 2020 Problem D: Paint Bucket Solution and Explanation]]

=== B - Broken Clock <posts-school-2020-hspc-b-broken-clock>
...
+ *Use set unions and intersections to determine what the possible numbers for
  each digit are.*
...
+ Use recursion to generate possible times in-order. In this solution, the
...
=== G - Tax Calc <posts-school-2020-hspc-g-tax-calc>
