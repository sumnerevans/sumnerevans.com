...
#set document(
  ...
  date: datetime(year: 2018, month: 11, day: 3),
  extra: (
    categories: ("School",),
...
== The Competition <posts-school-2018-11-03-icpc-the-competition>
...
- *A*: #link("https://rmc18.kattis.com/problems/qaly")[Quality-Adjusted Life-Year] -
  trivial
- *B*: #link("https://rmc18.kattis.com/problems/gwensgift")[Gwen's Gift] - some sort
  of combinatorics math
- *C*:
  #link("https://rmc18.kattis.com/problems/forestforthetrees")[Forest for the Trees] -
  a geometry/ray-tracing question
- *D*: #link("https://rmc18.kattis.com/problems/hindex")[H-Index] - trivial (list
  processing)
- *E*: #link("https://rmc18.kattis.com/problems/drivinglanes")[Driving Lanes] -
...
- *F*:
  #link("https://rmc18.kattis.com/problems/treasurespotting")[Treasure Spotting] -
  another geometry/ray-tracing problem
- *G*:
  #link("https://rmc18.kattis.com/problems/neighborhoodwatch")[Neighborhood Watch] - DP
  path counting (it ended up being some very simple math)
- *H*: #link("https://rmc18.kattis.com/problems/smallschedule")[Small Schedule] - DP
  scheduling (it ended up being one just being a fairly simple math problem)
- *I*: #link("https://rmc18.kattis.com/problems/plowking")[Mr. Plow King] - Maximal
  MST (I thought it might be DP, but it didn't end up being DP which was nice)
- *J*:
  #link("https://rmc18.kattis.com/problems/rainbowroadrace")[Rainbow Road Race] - Graph
  craziness
...
== Competition Results <posts-school-2018-11-03-icpc-competition-results>
