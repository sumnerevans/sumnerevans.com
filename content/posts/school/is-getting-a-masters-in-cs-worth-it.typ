...
#set document(
  ...
  description: "Should you get a master's degree in computer science? In this article, I give\nmy perspective on whether or not getting a master's degree is worth the effort\nand money.",
  date: datetime(year: 2024, month: 2, day: 26),
  extra: (
    categories: ("School", "Software Engineering"),
    tags: ("Computer Science", "Masters Degree"),
    keywords: ("Opportunity Cost", "Starting Salary", "Employability"),
  ),
)
#show: page-template
...
#link("https://sumnerevans.com../hackathons/hackcu-v/")[attend] and
#link("https://sumnerevans.com../hackathons/2018-11-16-facebook-hackathon-the-competition/")[win]
multiple hackathons, #link("https://sumnerevans.com../school/2018-11-03-icpc")[compete in ICPC],
organise and run the second annual
#link("https://sumnerevans.com../school/2019-hspc.rst")[CS\@Mines High School Programming
Competition], act as Chair of Mines ACM and
Linux Help Guru for the Mines Linux Users Group,
#link("https://sumnerevans.com../../portfolio#experience-on-tour")[teach middle and high school
...
an #link("https://sumnerevans.com../../portfolio#experience-adjunct-mines")[adjunct at Mines]. And
...
= Three Reasons to Get a Master's Degree <posts-school-is-getting-a-masters-in-cs-worth-it-three-reasons-to-get-a-masters-degree>

I think there are three main reasons for getting a master's degree in computer
science:

+ *#link(<posts-school-is-getting-a-masters-in-cs-worth-it-1-financial>)[Financial]: you want to make more money.*
  ...
  #link("https://en.wikipedia.org/wiki/Zero_interest-rate_policy")[ZIRP] might be
...
+ *#link(<posts-school-is-getting-a-masters-in-cs-worth-it-2-academic>)[Academic]: you want to learn more to prepare yourself better
...
+ *#link(<posts-school-is-getting-a-masters-in-cs-worth-it-3-social>)[Social]: you are not ready for the "real world" yet and want
...
= 1. Financial <posts-school-is-getting-a-masters-in-cs-worth-it-1-financial>
...
#link(<posts-school-is-getting-a-masters-in-cs-worth-it-11-higher-salaries>)[higher starting salaries] and sometimes have
#link(<posts-school-is-getting-a-masters-in-cs-worth-it-12-increased-employability>)[increased employability], but this comes with
#link(<posts-school-is-getting-a-masters-in-cs-worth-it-13-opportunity-cost>)[opportunity costs] and potentially additional
#link(<posts-school-is-getting-a-masters-in-cs-worth-it-14-debt>)[debt].

== 1.1. Higher Salaries <posts-school-is-getting-a-masters-in-cs-worth-it-11-higher-salaries>
...
#link("https://en.wikipedia.org/wiki/Selection_bias")[_selection bias_] to account for.
...
== 1.2. Increased Employability <posts-school-is-getting-a-masters-in-cs-worth-it-12-increased-employability>
...
- *The 60th-90th percentile of their undergraduate class*
  ...
  #link(<posts-school-is-getting-a-masters-in-cs-worth-it-13-opportunity-cost>)[*Section 1.3. Opportunity Cost*], there are still
...
== 1.3. Opportunity Cost <posts-school-is-getting-a-masters-in-cs-worth-it-13-opportunity-cost>
...
#html.elem("table", attrs: ("class": "data"))[#html.elem("thead")[#html.elem("tr", attrs: ("class": "border-bottom"))[#html.elem("th", attrs: ("scope": "col"))[]#html.elem("th", attrs: ("class": "border-right", "colspan": "2", "scope": "col"))[#html.elem("b")[John]]#html.elem("th", attrs: ("colspan": "2", "scope": "col"))[#html.elem("b")[Juan]]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "col"))[#html.elem("b")[Year]]#html.elem("th", attrs: ("scope": "col"))[#html.elem("b")[Earned]]#html.elem("th", attrs: ("class": "border-right", "scope": "col"))[#html.elem("b")[Lifetime]]#html.elem("th", attrs: ("scope": "col"))[#html.elem("b")[Earned]]#html.elem("th", attrs: ("scope": "col"))[#html.elem("b")[Lifetime]]]]#html.elem("tbody")[#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right"))[1]#html.elem("td", attrs: ("class": "align-right"))[-30.00k]#html.elem("td", attrs: ("class": "align-right border-right"))[-30.00k]#html.elem("td", attrs: ("class": "align-right"))[100.00k]#html.elem("td", attrs: ("class": "align-right"))[100.00k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[2]#html.elem("td", attrs: ("class": "align-right"))[\$115.00k]#html.elem("td", attrs: ("class": "align-right border-right"))[\$85.00k]#html.elem("td", attrs: ("class": "align-right"))[\$105.00k]#html.elem("td", attrs: ("class": "align-right"))[\$205.00k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[3]#html.elem("td", attrs: ("class": "align-right"))[\$120.75k]#html.elem("td", attrs: ("class": "align-right border-right"))[\$205.75k]#html.elem("td", attrs: ("class": "align-right"))[\$110.25k]#html.elem("td", attrs: ("class": "align-right"))[\$315.25k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[4]#html.elem("td", attrs: ("class": "align-right"))[\$126.79k]#html.elem("td", attrs: ("class": "align-right border-right"))[\$332.54k]#html.elem("td", attrs: ("class": "align-right"))[\$115.76k]#html.elem("td", attrs: ("class": "align-right"))[\$431.01k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[5]#html.elem("td", attrs: ("class": "align-right"))[\$133.13k]#html.elem("td", attrs: ("class": "align-right border-right"))[\$465.66k]#html.elem("td", attrs: ("class": "align-right"))[\$121.55k]#html.elem("td", attrs: ("class": "align-right"))[\$552.56k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[6]#html.elem("td", attrs: ("class": "align-right"))[\$139.78k]#html.elem("td", attrs: ("class": "align-right border-right"))[\$605.45k]#html.elem("td", attrs: ("class": "align-right"))[\$127.63k]#html.elem("td", attrs: ("class": "align-right"))[\$680.19k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[7]#html.elem("td", attrs: ("class": "align-right"))[\$146.77k]#html.elem("td", attrs: ("class": "align-right border-right"))[\$752.22k]#html.elem("td", attrs: ("class": "align-right"))[\$134.01k]#html.elem("td", attrs: ("class": "align-right"))[\$814.20k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[8]#html.elem("td", attrs: ("class": "align-right"))[\$154.11k]#html.elem("td", attrs: ("class": "align-right border-right"))[\$906.33k]#html.elem("td", attrs: ("class": "align-right"))[\$140.71k]#html.elem("td", attrs: ("class": "align-right"))[\$954.91k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[9]#html.elem("td", attrs: ("class": "align-right"))[\$161.82k]#html.elem("td", attrs: ("class": "align-right border-right"))[\$1,068.15k]#html.elem("td", attrs: ("class": "align-right"))[\$147.75k]#html.elem("td", attrs: ("class": "align-right"))[\$1,102.66k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[10]#html.elem("td", attrs: ("class": "align-right"))[\$169.91k]#html.elem("td", attrs: ("class": "align-right border-right"))[\$1,238.05k]#html.elem("td", attrs: ("class": "align-right"))[\$155.13k]#html.elem("td", attrs: ("class": "align-right"))[\$1,257.79k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[11]#html.elem("td", attrs: ("class": "align-right"))[\$178.40k]#html.elem("td", attrs: ("class": "align-right border-right"))[\$1,416.46k]#html.elem("td", attrs: ("class": "align-right"))[\$162.89k]#html.elem("td", attrs: ("class": "align-right"))[\$1,420.68k]]#html.elem("tr")[#html.elem("th", attrs: ("class": "border-right", "scope": "row"))[12]#html.elem("td", attrs: ("class": "align-right"))[\$187.32k]#html.elem("td", attrs: ("class": "align-right border-right"))[#html.elem("b")[\$1,603.78k]]#html.elem("td", attrs: ("class": "align-right"))[\$171.03k]#html.elem("td", attrs: ("class": "align-right"))[#html.elem("b")[\$1,591.71k]]]]]
...
#link("https://techcrunch.com/2024/04/09/wordpress-com-owner-automattic-acquires-multi-service-messaging-app-beeper-for-125m/")[the exit was favourable].
...
== 1.4. Debt <posts-school-is-getting-a-masters-in-cs-worth-it-14-debt>
...
#link("https://sumnerevans.com../../portfolio#education-rrcc")[Red Rocks Community College] while I
...
== 1.5. Recession <posts-school-is-getting-a-masters-in-cs-worth-it-15-recession>
...
#link("https://siepr.stanford.edu/publications/policy-brief/recession-graduates-long-lasting-effects-unlucky-draw")[Studies]
#link("https://www.nber.org/digest/nov06/career-effects-graduating-recession")[show]
...
== 1.6. Conclusion <posts-school-is-getting-a-masters-in-cs-worth-it-16-conclusion>
...
= 2. Academic <posts-school-is-getting-a-masters-in-cs-worth-it-2-academic>
...
+ #link(<posts-school-is-getting-a-masters-in-cs-worth-it-21-the-joy-of-learning>)[*The joy of learning*]: you just like learning,
  and don't feel like your undergraduate studies sufficiently quenched your
  desire to learn.
+ #link(<posts-school-is-getting-a-masters-in-cs-worth-it-22-becoming-an-educator>)[*To become an educator*]: you want to teach
  others computer science (either at a middle/high school level or college
  level).
+ #link(<posts-school-is-getting-a-masters-in-cs-worth-it-23-becoming-an-expert-in-a-specific-topic>)[*Becoming an expert in a specific
  topic*]: you want to be a
...
== 2.1. The Joy of Learning <posts-school-is-getting-a-masters-in-cs-worth-it-21-the-joy-of-learning>
...
== 2.2. Becoming an Educator <posts-school-is-getting-a-masters-in-cs-worth-it-22-becoming-an-educator>
...
== 2.3. Becoming an Expert in a Specific Topic <posts-school-is-getting-a-masters-in-cs-worth-it-23-becoming-an-expert-in-a-specific-topic>
...
== 2.4. What About Software Engineers? <posts-school-is-getting-a-masters-in-cs-worth-it-24-what-about-software-engineers>
...
= 3. Social <posts-school-is-getting-a-masters-in-cs-worth-it-3-social>
...
= 4. Conclusion <posts-school-is-getting-a-masters-in-cs-worth-it-4-conclusion>
