...
/* TODO twyla-convert: hugo shortcode: image src=&quot;images/logo.png&quot; alt=&quot;Sublime Music&quot; link=&quot;https://sublimemusic.app&quot; width=&quot;50%&quot; */
...
== Thank You! <posts-projects-sublime-music-eom-thank-you>
...
== What Now? <posts-projects-sublime-music-eom-what-now>
...
#link("https://github.com/dweymouth/supersonic")[Supersonic]. It's a project built in
Go using the #link("https://fyne.io/")[Fyne] library and if it was around when I
started Sublime Music, I probably would never have started my own project.

== Retrospective <posts-projects-sublime-music-eom-retrospective>
...
- *I was also able to use my (small amounts) of design skill.* I think I build
  ...
  #link("https://sublimemusic.app")[website for Sublime Music] which I'm pretty proud
  of as well.
- *I learned that ORMs are probably always waste of time.* Working on this
  ...
  since then (namely the #link("https://github.com/mautrix")[mautrix] bridges and other
  projects for Beeper) has convinced me that ORMs are a waste of time. I used
  the #link("http://docs.peewee-orm.com/en/latest/")[peewee] ORM which is quite
...
- *I think this project helped me get my current job.* When I spoke to
  #link("https://www.linkedin.com/in/ericmigi/")[Eric] for the first time about working
