...
#set document(
  ...
  description: [
    ...
    I have decided that I will not stand again in this year's #link("https://matrix.org/foundation/governing-board-elections/2025/")[Matrix Governing
    Board elections].
    I recently
    #link("https://sumnerevans.com../../portfolio/index.html#experience-canam-tech-lead")[joined Can/Am Technologies as a tech lead]
...
== Greg Sutcliffe <posts-matrix-2025-matrix-governing-board-endorsements-greg-sutcliffe>
...
== Brad Murray <posts-matrix-2025-matrix-governing-board-endorsements-brad-murray>
