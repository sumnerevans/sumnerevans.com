...
#set document(
  ...
  description: "I would like to endorse a Kim Brose and Nicolas Werner (Nico) as ecosystem\nmember candidates for the Matrix Governing Board.\n",
  date: datetime(year: 2024, month: 5, day: 8),
  extra: (
    categories: ("Matrix",),
    tags: ("Matrix", "Matrix Governing Board", "Endorsements"),
    aliases: ("../technology/2024-matrix-governing-board-endorsements",),
  ),
)
#show: page-template

I'm running for the Matrix Governing Board as an Individual Member (see my
#link("https://sumnerevans.com./2024-matrix-governing-board.md")[Platform]) and I am only eligible
...
== Kim Brose <posts-matrix-2024-matrix-governing-board-endorsements-kim-brose>
...
#link("https://sumnerevans.com../travel/2022-berlin-matrix-summit/summit/index.md")[first Community Matrix Summit]
and has been active in organizing many other Matrix community events including
the
#link("https://sumnerevans.com../travel/2023-fosdem/fosdem/index.md#the-matrix-community-meetup")[2023]
and
#link("https://sumnerevans.com../travel/2024-fosdem/fosdem/index.md#matrix-community-meetup")[2024]
...
#link("https://github.com/imbev/simplematrixbotlib")[simplematrixbotlib], and
...
== Nico <posts-matrix-2024-matrix-governing-board-endorsements-nico>
