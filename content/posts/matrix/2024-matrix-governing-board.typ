...
#set document(
  ...
  description: [
    ...
    *2024-06-03*: The results of the first Governing Board Election have been
    #link("https://matrix.org/blog/2024/06/election-results/")[posted on the Matrix.org Blog].
    ...
    I'm
    #link("https://matrix.org/blog/2023/12/electing-our-first-governing-board/#election-timeline")[running for the Matrix Governing Board]
    as an Individual Member. I work on bridges\[^1\] and backend infrastructure\[^2\] as
    a software engineer at #link("https://www.beeper.com")[Beeper]. You may have met me at
  ...
  date: datetime(year: 2024, month: 4, day: 24),
  extra: (
    categories: ("Matrix",),
    tags: ("Matrix Governing Board", "Element", "Matrix", "Matrix Foundation", "Chat", "Cryptography"),
    aliases: ("../technology/2024-matrix-governing-board",),
  ),
)
#show: page-template
...
See also my
#link("https://sumnerevans.com./2024-matrix-governing-board-endorsements.md")[endorsements of Ecosystem Member]
candidates.
...
== My Platform <posts-matrix-2024-matrix-governing-board-my-platform>
...
=== 1. Focus on Chat <posts-matrix-2024-matrix-governing-board-1-focus-on-chat>
...
=== 2. Ecosystem Diversity <posts-matrix-2024-matrix-governing-board-2-ecosystem-diversity>
...
== Specific Policies <posts-matrix-2024-matrix-governing-board-specific-policies>
...
=== No Covert Element Promotion <posts-matrix-2024-matrix-governing-board-no-covert-element-promotion>
...
=== Normalize Experimentation <posts-matrix-2024-matrix-governing-board-normalize-experimentation>
...
=== Clean Up the `matrix-org` GitHub Organization <posts-matrix-2024-matrix-governing-board-clean-up-the-matrix-org-github-organization>
...
the #link("https://github.com/matrix-org/matrix-spec")[Matrix Spec] and
#link("https://github.com/matrix-org/matrix-spec-proposals")[Matrix Spec Proposals] as
...
#link("https://github.com/matrix-org/matrix.org")[matrix.org] website and TWIM-related
...
#link("https://github.com/matrix-org/matrix-react-sdk")[React SDK] and many other old,
...
== Conclusion <posts-matrix-2024-matrix-governing-board-conclusion>
...
== Responses to Feedback About This Platform <posts-matrix-2024-matrix-governing-board-responses-to-feedback-about-this-platform>

I posted a link to this blog post on
#link("https://matrix.org/blog/2024/05/10/this-week-in-matrix-2024-05-10/")[this week's TWIM]
and I'm thankful that it received a lot of attention and debate in the
#link("https://matrix.to/#/#thisweekinmatrix:matrix.org")[\#thisweekinmatrix:matrix.org room].
...
=== Matthew's Initial Response <posts-matrix-2024-matrix-governing-board-matthews-initial-response>

Matthew first responded in
#link("https://matrix.to/#/!QQpfJfZvqxbCfeDgCj:matrix.org/$5RxSXoE0P1_hWX5-2Y8BI7_oS0EMdgFmaCCNkIxxgUQ?via=matrix.org&via=envs.net&via=element.io")[this message]
...
- Travis in a
  #link("https://matrix.to/#/!QQpfJfZvqxbCfeDgCj:matrix.org/$EB6KJgFwYkm-LI3BEhcrxZsL78_d4yle2XcretO86WE?via=matrix.org&via=envs.net&via=element.io")[message quickly after Matthew's]
  said:
...
=== Matthew's Follow-Up Regarding Separation of Element and Matrix <posts-matrix-2024-matrix-governing-board-matthews-follow-up-regarding-separation-of-element-and-matrix>

Matthew responded to his first messages with this
#link("https://matrix.to/#/!QQpfJfZvqxbCfeDgCj:matrix.org/$WXN3bQhl3WZM-LkexI4E8rnl9SG0jxdbUysQhlnsI0g?via=matrix.org&via=envs.net&via=element.io")[second message]
...
=== On Calling The `matrix-org` GitHub Organization a "dumping ground for Element projects" <posts-matrix-2024-matrix-governing-board-on-calling-the-matrix-org-github-organization-a-dumping-ground-for-element-projects>

In
#link("https://matrix.to/#/!QQpfJfZvqxbCfeDgCj:matrix.org/$Ko1pNrPINtJmqI6JradZNlb95DStB19nWUv6_OsSyjg?via=matrix.org&via=envs.net&via=element.io")[this message],
...
+ Call out that that Element was the only entity that was allowed to donate
  ...
  option.)
+ Assert that many of the project donations should not have been accepted by
  the Foundation (and that the Foundation must retroactively rectify this).
+ Propose that a set of neutral requirements should be established for projects
...
=== Matthew's Reply to Clarifications <posts-matrix-2024-matrix-governing-board-matthews-reply-to-clarifications>

After I made the above edits to this post, Matthew responded in the TWIM room
with
#link("https://matrix.to/#/!QQpfJfZvqxbCfeDgCj:matrix.org/$UbnrX9btMs3N4Vyq7RHBKFjSuy5tYJTUIQRviL85wf8?via=matrix.org&via=envs.net&via=element.io")[this message]:
...
#link("https://docs.google.com/document/d/1zMMSjUD2JUFl4jlc6QJfgNMkz-iyBwKvITLmVpJ2zyw/edit")[this Google Doc].
...
there is both the #link("https://github.com/NixOS/")[NixOS organization] and the
#link("https://github.com/nix-community/")[Nix Community organization]. I think that
...
+ *What is the mandate of the Core Team?*
...
+ *If the Foundation were in a position to fund the entire Core Team, would
  it?*
...
+ *Who gets to be on the Core Team?*
...
#link(<posts-matrix-2024-matrix-governing-board-normalize-experimentation>)[normalizing experimentation], the Foundation has a
...
#link("https://github.com/beeper/linkedin")[LinkedIn],
#link("https://github.com/mautrix/imessage")[iMessage], and
#link("https://github.com/mautrix/whatsapp")[WhatsApp]; and I've contributed to the
rest of the #link("https://github.com/mautrix")[mautrix] bridges and the
#link("https://github.com/mautrix/go")[Go] and
#link("https://github.com/mautrix/python")[Python] SDKs.

\[^2\]: Notably, I started the
#link("https://github.com/sumnerevans/hungryserv-presentation")[hungryserv] project.
I've also built a few Matrix bots including
#link("https://github.com/beeper/chatwoot")[chatwoot] and
#link("https://github.com/beeper/standupbot")[standupbot].

\[^3\]: I went to the \[first Berlin Matrix Community Summit\](/* TODO twyla-convert: hugo shortcode: ref
&quot;../travel/2022-berlin-matrix-summit/summit&quot; */) and FOSDEM in both #link("https://sumnerevans.com../travel/2023-fosdem/fosdem")[2023] and \[2024\](/* TODO twyla-convert: hugo shortcode: ref
...
#link("https://github.com/matrix-org/matrix-spec/pull/1719")[\#1719] and
#link("https://github.com/matrix-org/matrix-spec/pull/1720")[\#1720] and I clarified
...
incorrectly in #link("https://github.com/matrix-org/matrix-spec/pull/1712")[\#1712]. I
also clarified a detail of the `/context` endpoint in
#link("https://github.com/matrix-org/matrix-spec/pull/1239")[\#1239].

\[^7\]: I authored
#link("https://github.com/matrix-org/matrix-spec-proposals/pull/4027")[MSC4027: Propose method of specifying custom images in reactions]
and I contributed to
#link("https://github.com/matrix-org/matrix-spec-proposals/pull/2246")[MSC2246: Asynchronous media uploads]
by #link("https://github.com/tulir")[Tulir] and
#link("https://github.com/matrix-org/matrix-spec-proposals/pull/3860")[MSC3860: Media Download Redirects]
by #link("https://github.com/Fizzadar")[Nick Mills-Barrett].

\[^8\]: I implemented
#link("https://github.com/matrix-org/synapse/pull/15503")[Asynchronous Uploads] which
necessitated a
#link("https://github.com/matrix-org/synapse/pull/12832")[fix to the `LockStore`] which
was previously not correctly linearized. I've also contributed to improving the
documentation in #link("https://github.com/matrix-org/synapse/pull/11221")[\#11221],
#link("https://github.com/matrix-org/synapse/pull/13228")[\#13228], and
#link("https://github.com/matrix-org/synapse/pull/15852")[\#15852].

\[^9\]: I implemented
#link("https://github.com/matrix-org/matrix-react-sdk/pull/11087")[rendering custom images in reactions]
for #link("https://github.com/matrix-org/matrix-spec-proposals/pull/4027")[MSC4027] and
fixed a bug where
#link("https://github.com/matrix-org/matrix-react-sdk/pull/8590")[notifications were disabled while Element was
focused].

\[^10\]: DerLukas has started #link("https://codeberg.org/DerLukas/goolm")[goolm] which
we integrated into #link("https://github.com/mautrix/go")[mautrix-go] as an
