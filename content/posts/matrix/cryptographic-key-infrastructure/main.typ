...
#link("https://sumnerevans.com/portfolio/#presentation-matrix-crypto-key-infra")[talk I gave at the 2024 Matrix Conference]
by the same name.

#html.elem("a", attrs: ("href": "slides.pdf", "target": "_blank"))[/* TODO twyla-convert: hugo shortcode: ico &quot;tabler&quot; &quot;outline/file-type-pdf&quot; */ Slides]
|
#html.elem("a", attrs: ("href": "slides-with-notes.pdf", "target": "_blank"))[/* TODO twyla-convert: hugo shortcode: ico &quot;tabler&quot; &quot;outline/file-type-pdf&quot; */ Slides + Notes]

/* TODO twyla-convert: hugo shortcode: youtube id=&quot;4uC-S0Bb5-g&quot; title=&quot;Matrix Cryptographic Key Infrastructure - Sumner Evans&quot; */

#html.elem("details", attrs: ("class": "youtube-expander", "open": ""))[#html.elem("summary")[Matrix Cryptographic Key Infrastructure - Sumner Evans]]
...
== Big Picture <posts-matrix-cryptographic-key-infrastructure-big-picture>
...
=== Message Security <posts-matrix-cryptographic-key-infrastructure-message-security>
...
#image("./images/message-security.png")

We aren't going to discuss this in detail today. I wrote a full
#link("https://sumnerevans.com../megolm/index.md")[article about Megolm] if you want to learn more.
...
=== Identity <posts-matrix-cryptographic-key-infrastructure-identity>
...
#image("./images/identity-overview.png")
...
=== The Other Stuff <posts-matrix-cryptographic-key-infrastructure-the-other-stuff>
...
/* TODO twyla-convert: hugo ref link */Matrix Cryptography Prerequisites
companion article which describes the prerequisites in enough detail to
understand the rest of this article.

]

== Sharing Keys <posts-matrix-cryptographic-key-infrastructure-sharing-keys>
...
=== Encrypted Olm Events <posts-matrix-cryptographic-key-infrastructure-encrypted-olm-events>
...
#image("./images/to-device-zoomed.png")
...
#link("https://en.wikipedia.org/wiki/Double_Ratchet_Algorithm")[Signal double-ratchet algorithm].
...
=== Key Backup <posts-matrix-cryptographic-key-infrastructure-key-backup>

In the following diagram, I got rid of everything not related to key backup.

#image("./images/key-backup-zoomed.png")
...
\[\\textbf{ECDH}(A\_{private}, B\_{public}) = \\textbf{ECDH}(B\_{private},
A\_{public}) = K\_{shared} \]
...
#link("https://github.com/matrix-org/matrix-spec/pull/1712")[matrix-org/matrix-spec\#1712].

So, the MAC is not really useful at all in its current state. I'm hoping that a
future version of the spec fixes this.

== Device Verification <posts-matrix-cryptographic-key-infrastructure-device-verification>

Recall how I said in #link(<posts-matrix-cryptographic-key-infrastructure-encrypted-olm-events>)[Encrypted Olm Events] that we only
...
#image("./images/identity-device-verification-zoomed.png")
...
== User Verification <posts-matrix-cryptographic-key-infrastructure-user-verification>
...
#image("./images/identity-user-verification-zoomed.png")
...
== Secure Secret Storage and Sharing (SSSS) <posts-matrix-cryptographic-key-infrastructure-secure-secret-storage-and-sharing-ssss>
...
== Conclusion <posts-matrix-cryptographic-key-infrastructure-conclusion>
