...
#set document(
  ...
  date: datetime(year: 2021, month: 7, day: 12),
  extra: (
...
/* TODO twyla-convert: hugo shortcode: image src=&quot;images/beeper.png&quot; link=&quot;https://beeper.com&quot; width=&quot;50%&quot; */

#html.elem("center")[]

Today I am happy to announce that I have joined #link("https://beeper.com")[Beeper], a
...
Beeper is built on top of the #link("https://matrix.org")[Matrix protocol] which is an
...
#link("https://thetradedesk.com")[The Trade Desk], and will miss all of my co-workers
