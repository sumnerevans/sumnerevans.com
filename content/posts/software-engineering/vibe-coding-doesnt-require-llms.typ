...
#set document(
  ...
  extra: (
    ...
    aliases: ("/posts/programming/vibe-coding-doesnt-require-llms",),
  ),
)
#show: page-template

I recently read
#link("https://alexkondov.com/i-know-when-youre-vibe-coding/")[_I Know When You're Vibe Coding_]
by #link("https://alexkondov.com/")[Alex Kondov] in which he described certain
