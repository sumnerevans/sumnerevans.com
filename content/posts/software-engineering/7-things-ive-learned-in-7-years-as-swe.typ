...
#set document(
  ...
  description: "In this article, I share seven things that I've learned to do seven years into\nmy career as a software engineer.\n",
  ...
  extra: (
    ...
    math: true,
    aliases: ("/posts/programming/7-things-ive-learned-7-years-into-my-career",),
  ),
)
#show: page-template

A few months ago, I was asked to give the keynote address at the BlasterHacks
hackathon hosted at Mines by their #link("https://acm.mines.edu/")[ACM] chapter. I
wasn't quite sure what would be interesting to talk about for the keynote, so I
asked some friends. #link("https://byronsharman.com/")[Byron] suggested that I either
...
== 1. Focus on the Customer <posts-software-engineering-7-things-ive-learned-in-7-years-as-swe-1-focus-on-the-customer>
...
#link("https://sumnerevans.com../../portfolio/index.html#experience-canam-tech-lead")[current job]).
...
== 2. Solve Problems That Actually Exist <posts-software-engineering-7-things-ive-learned-in-7-years-as-swe-2-solve-problems-that-actually-exist>
...
== 3. Build Core Features First <posts-software-engineering-7-things-ive-learned-in-7-years-as-swe-3-build-core-features-first>
...
== 4. Don't Prematurely Optimize <posts-software-engineering-7-things-ive-learned-in-7-years-as-swe-4-dont-prematurely-optimize>
...
== 5. Learn Something New <posts-software-engineering-7-things-ive-learned-in-7-years-as-swe-5-learn-something-new>
...
your technical knowledge. I'm a fan of the #link("https://changelog.com/")[Changelog]
and #link("https://coder.show/")[Coder Radio] podcasts in particular, and obviously
#link("https://www.youtube.com/@ThePrimeTimeagen")[The Primeagen]. I do not, however
...
== 6. Support Your Teammates <posts-software-engineering-7-things-ive-learned-in-7-years-as-swe-6-support-your-teammates>

When I gave the BlasterHacks keynote three months ago, I had yet to start my
#link("https://sumnerevans.com../life-updates/joining-canam/index.md")[new job at Can/Am Technologies]
...
+ *Check in on each other.* Making sure that your coworkers are doing well is
...
+ *Make sure your teammates are not blocked, don’t be afraid to put two brains
...
+ *Make sure your teammates take care of themselves, it’s a marathon, not a
  ...
  There was a
  #link("https://fallthrough.transistor.fm/19")[recent fallthrough episode] in which
...
== 7. Have Fun <posts-software-engineering-7-things-ive-learned-in-7-years-as-swe-7-have-fun>
...
+ *Customer impact.* I love being able to see the software that I write
  impact customer's lives positively. When I was
  #link("https://sumnerevans.com../../../portfolio/index.html#experience-beeper")[at Beeper],
  ...
  #link("https://sumnerevans.com../../../portfolio/index.html#experience-canam-tech-lead")[at Can/Am]
...
+ *Great teammates.* I place a high premium on good teammates. I feel like
  with a good team, anything is possible. At Beeper, I was especially proud of
  how the team came together to build
  #link("https://blog.beeper.com/2023/12/05/introducing-beeper-mini-get-blue-bubbles-on-android-%f0%9f%92%99/")[Beeper Mini]
