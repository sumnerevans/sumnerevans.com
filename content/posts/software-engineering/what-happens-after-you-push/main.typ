...
#set document(
  ...
  description: "A survey of how code gets deployed and monitored, and how that impacts SWEs\n",
  date: datetime(year: 2025, month: 2, day: 25),
  extra: (
    categories: ("Software Engineering",),
    tags: ("CI/CD", "Linting", "Containers", "Container Orchestration", "Monitoring", "Logging"),
    image: "images/so-cicd.png",
    build: (
      publishResources: false,
    ),
    aliases: ("/posts/programming/what-happens-after-you-push",),
  ),
)
#show: dir-template
...
#link(<posts-software-engineering-what-happens-after-you-push-cicd>)[Continuous Integration and Continuous Delivery (CI/CD)],
#link(<posts-software-engineering-what-happens-after-you-push-containerization-and-orchestration>)[Containerization and Orchestration], and
#link(<posts-software-engineering-what-happens-after-you-push-monitoring-and-logging>)[Monitoring and Logging].

== Continuous Integration and Continuous Delivery (CI/CD) <posts-software-engineering-what-happens-after-you-push-cicd>

According to the 2024 StackOverflow Survey, CI/CD is used by nearly 70% of all
developers.\[^1\]

\[^1\]: #link("https://survey.stackoverflow.co/2024/professional-developers#developer-experience-professional-tech")[2024 StackOverflow Developer Survey: Processes, tools, and programs within an organization]



=== Continuous Delivery <posts-software-engineering-what-happens-after-you-push-continuous-delivery>
...
==== Continuous Delivery Methods <posts-software-engineering-what-happens-after-you-push-continuous-delivery-methods>
...
==== Continuous Delivery Tools <posts-software-engineering-what-happens-after-you-push-continuous-delivery-tools>
...
#link("https://argoproj.github.io/cd/")[Argo CD] for managing our Kubernetes clusters
and a bunch of custom software for deploying various parts of our
infrastructure.

Simpler projects might use things like
#link("https://github.com/features/actions")[GitHub Actions] or
#link("https://about.gitlab.com/topics/ci-cd/")[GitLab CI/CD] to automate deployment of
their application.

==== Adding Continuous Delivery to Your Project <posts-software-engineering-what-happens-after-you-push-adding-continuous-delivery-to-your-project>
...
a
#link("https://github.com/sumnerevans/sumnerevans.com/blob/master/.github/workflows/build.yaml")[GitHub Action]
which builds the website using #link("https://gohugo.io/")[Hugo] and deploys it to
#link("https://pages.github.com/")[GitHub Pages]. It's not anything fancy, but just
getting familiar with the concepts and tools is valuable.

At work, every push to the `main` branch of a
#link("https://github.com/mautrix")[mautrix bridge repositories] invokes a build and
...
#link("https://mau.dev/mautrix/ci")[GitLab CI/CD pipeline definition].

=== Continuous Integration <posts-software-engineering-what-happens-after-you-push-continuous-integration>
...
==== Source Control <posts-software-engineering-what-happens-after-you-push-source-control>

The first way to reduce the chaos is to use a source control system such as
#link("https://git-scm.com/")[Git]. I've discussed Git in
#link("https://sumnerevans.com../../../portfolio/index.html#presentation-acm-git-good")[a past presentation for ACM].
...
==== Automation <posts-software-engineering-what-happens-after-you-push-automation>
...
==== Continuous Integration Tools <posts-software-engineering-what-happens-after-you-push-continuous-integration-tools>

Many of the tools that I mentioned in the
#link(<posts-software-engineering-what-happens-after-you-push-continuous-delivery>)[Continuous Delivery] section also provide CI
capabilities. Some of the most common overarching tools include:

- #link("https://github.com/features/actions")[GitHub Actions]: great if you are
  already using GitHub.
- #link("https://about.gitlab.com/topics/ci-cd/")[GitLab CI/CD]: great if you are
  already using GitLab.
- #link("https://www.jenkins.io/doc/tutorials/")[Jenkins]: one of the oldest and most
  widely used CI/CD solutions.
- #link("https://www.atlassian.com/software/bamboo")[Bamboo]: great if you are already
...
- #link("https://pre-commit.com/")[pre-commit] for configuring a set of automated
  checks to run.
  #link("https://github.com/mautrix/telegramgo/actions/runs/13461485321/job/37617658811")[Example run]
  and
  #link("https://github.com/mautrix/telegramgo/blob/f0f92c9dd98a739a3f70821d0ca2a3a79b17fe17/.pre-commit-config.yaml")[config].
- #link("https://black.readthedocs.io/en/stable/")[black] formatter for Python. I like
  this one because it's very opinionated and highly deterministic.
- #link("https://pkg.go.dev/cmd/gofmt")[gofmt] and
  #link("https://pkg.go.dev/golang.org/x/tools/cmd/goimports")[goimports] formatters
  for Go. These are also highly opinionated and result in all Go code being
  formatted the same way.
- Go #link("https://pkg.go.dev/cmd/vet")[vet] for finding common mistakes in Go code.
- #link("https://rust-lang.github.io/rustfmt/")[rustfmt] formatter for Rust.

==== What CI Means for Software Engineers <posts-software-engineering-what-happens-after-you-push-what-ci-means-for-software-engineers>

How does CI affect the day-to-day of a software engineer? I think that there are
three main implications:

+ *Do all (or almost all) of your work on a branch.* This will allow you to
...
+ *Commit early and often, and push liberally.* Every commit is a savefile
  for your code, and pushing ensures that if your computer goes kaput, you'll
  not lose all your work.
+ *Don't rely on CI to do all the testing, linting and building for you.* You
...
==== Adding Continuous Integration to Your Project <posts-software-engineering-what-happens-after-you-push-adding-continuous-integration-to-your-project>
...
#link("https://github.com/sumnerevans/webfortune/blob/master/.github/workflows/deploy.yaml")[webfortune]
and even my
#link("https://github.com/sumnerevans/advent-of-code/blob/master/.github/workflows/go.yaml")[Advent of Code repo].

Open source projects I contribute to such as
#link("https://github.com/nix-community/home-manager")[Nix home-manager] run tests on
every PR.
...
== Containerization and Orchestration <posts-software-engineering-what-happens-after-you-push-containerization-and-orchestration>
...
\[^2\]: #link("https://survey.stackoverflow.co/2024/technology#most-popular-technologies-tools-tech")[2024 StackOverflow Survey: Other tools]



=== Docker <posts-software-engineering-what-happens-after-you-push-docker>
...
==== Using Docker in Your Project <posts-software-engineering-what-happens-after-you-push-using-docker-in-your-project>
...
=== Kubernetes <posts-software-engineering-what-happens-after-you-push-kubernetes>
...
#link("https://kubernetes.io/")[Kubernetes] comes in. Other solutions to container
orchestration such as #link("https://docs.docker.com/engine/swarm/")[Docker Swarm]
...
#link("https://docs.aws.amazon.com/AmazonECS/latest/developerguide/Welcome.html")[Amazon ECS]
and #link("https://learn.microsoft.com/en-us/azure/aks/what-is-aks")[Azure AKS].
...
== Monitoring and Logging <posts-software-engineering-what-happens-after-you-push-monitoring-and-logging>
...
=== Monitoring <posts-software-engineering-what-happens-after-you-push-monitoring>
...
- *Healthchecks and Heartbeats*: these involve an external service checking on
  ...
  successfully"? I use #link("https://uptimerobot.com/")[UptimeRobot] to monitor a few
  ...
  #link("https://healthchecks.io/")[Healthchecks.io] is an example of a service which
  takes this approach.
...
#link("https://www.pagerduty.com/")[PagerDuty]. Companies often require developers to
...
=== Logging <posts-software-engineering-what-happens-after-you-push-logging>
...
by the developer. Systems such as #link("https://grafana.com/docs/loki/latest/")[Loki]
and #link("https://www.datadoghq.com/")[Datadog] are commonly used in industry to
...
#link("https://stackoverflow.com/a/2031209/2319844")[this StackOverflow answer] to be a
...
== Conclusion <posts-software-engineering-what-happens-after-you-push-conclusion>
