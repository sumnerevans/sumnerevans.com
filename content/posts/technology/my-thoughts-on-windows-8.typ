...
#set document(
  ...
  date: datetime(year: 2013, month: 1, day: 17),
  extra: (
...
in love with it.  Well... not _really_ but... you know what I _meant_. Anyway,
...
on Windows 8). We were required to get Win8 CP (short of #strong[Win]dows *8*
#strong[C]onsumer #strong[P]review) for our computers for class. So, of course, I
...
becoming a standard for app development across _all_ platforms. _Including_ iOS.
...
too. iOS is _the best_ mobile operating system there is right now. Partly
