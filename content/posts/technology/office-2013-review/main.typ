...
#set document(
  ...
  date: datetime(year: 2013, month: 1, day: 27),
  extra: (
...
+ === Files First <posts-technology-office-2013-review-files-first>

  #image("./images/word2013preview.png", alt: "When you open Word, you immediately see your files.")
...
+ === SkyDrive Integration <posts-technology-office-2013-review-skydrive-integration>

  One feature that is _really_ cool is SkyDrive integration.  Basically,
...
+ === Smooth Cursor <posts-technology-office-2013-review-smooth-cursor>
...
+ === The Ribbon <posts-technology-office-2013-review-the-ribbon>
...
#table(
  columns: 2,
  table.header([I Currently Have...], [You Should...], ),
