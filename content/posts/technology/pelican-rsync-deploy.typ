...
#set document(
  title: "Setting up Pelican to Automatically Deploy Over Rsync",
...
= Overview <posts-technology-pelican-rsync-deploy-overview>

I am hosting the source code for my website publicly on GitHub at
#link("https://github.com/sumnerevans/sumnerevans.github.io")[github.com/sumnerevans/sumnerevans.github.io]
...
== Prerequisites <posts-technology-pelican-rsync-deploy-prerequisites>
...
= Setting up GitHub <posts-technology-pelican-rsync-deploy-setting-up-github>
...
#image("./pelican-on-github-pages/images/gh-pages-default-branch.png", alt: "select the branch from the dropdown")

Later on, we will be setting up Travis CI to use #link("https://docs.travis-ci.com/user/deployment/pages/")[GitHub Pages
Deployment]. You will need to
create a #link("https://help.github.com/articles/creating-a-personal-access-token-for-the-command-line/")[Personal Access
Token]
with `public_repo` access for this. Go ahead and create it now and save the
token for use in the "Set up Travis CI" step.

= Setting up Pelican <posts-technology-pelican-rsync-deploy-setting-up-pelican>
...
#link("https://github.com/sumnerevans/sumnerevans.github.io/blob/source/Makefile")[`sumnerevans.github.com/Makefile`].
...
= Setting up Travis CI <posts-technology-pelican-rsync-deploy-setting-up-travis-ci>
...
#image("./pelican-on-github-pages/images/travis-site-enable.png", alt: "enable Travis on site")
...
#image("./pelican-on-github-pages/images/travis-env-var.png", alt: "change environment variables")
...
= Conclusion <posts-technology-pelican-rsync-deploy-conclusion>
