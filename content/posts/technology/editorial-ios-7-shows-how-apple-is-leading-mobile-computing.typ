...
#set document(
  ...
  date: datetime(year: 2013, month: 6, day: 24),
  extra: (
...
#link("http://appleinsider.com/articles/13/06/22/editorial-ios-7-shows-how-apple-is-leading-mobile-computing")[Editorial: iOS 7 shows how Apple is leading mobile
computing]
