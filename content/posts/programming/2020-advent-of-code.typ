...
#set document(
  ...
  date: datetime(year: 2020, month: 12, day: 17),
  draft: true,
  extra: (
...
on `my Twitch channel <twitch_>`\_ and subsequently `upload them to my YouTube channel <youtube_>`\_.
...
= Summary of Results <posts-programming-2020-advent-of-code-summary-of-results>
...
Other people on the Mines leaderboard who solved all of the problems are `Colin Siles`_, McPqndq_, `Easton Bornemeier`_, `Keshav Vembar`_, johntaylor1309,
...
= My Favorite Problems <posts-programming-2020-advent-of-code-my-favorite-problems>

My favorite problem overall was day 20. It was a very fun and rewarding problem.

= Problem Summaries <posts-programming-2020-advent-of-code-problem-summaries>
...
+ *(1134/945, 2/2)* Day 1 required the use of use doubly (for part 1) and
  ...
  issue with the site going down, this day didn't count. `Day 1 VOD on YouTube`\_.
+ *(609/554, 3/3)* The key idea for Day 2 was counting the occurrences of a
  ...
  understand the problem (which you will see is a common theme). `Day 2 VOD on YouTube`\_.
+ *(1930/2689, 6/7)* For Day 3, the key insight is to use modular arithmetic
...
+ *(2854/1294, 10/1)* This problem was an input verification problem. For
  ...
  string, but I still managed a comeback win on Part 2. `Day 4 VOD on YouTube`\_.
+ *(1359/2656, 4/8)* Part 1 of Day 5 is trivial to solve if you have the key
  ...
  it as a binary search (which did work, but was _significantly_ slower to
...
+ *(438/448, 3/3)* This problem was another input verification problem. The
  first part was counting the _union_ of each group's responses and the second
  part was counting the _intersection_ of each group's responses. My
  implementation was pretty messy, but it was actually pretty reasonable as far
  as implementation time. Still only got 3rd on the private leaderboard. `Day 6 VOD on YouTube`\_.
+ *(360/830, 1/4)* This problem was a tree problem involving counting the
...
+ *(1923/580, 5/3)* This problem involved implementing a simple emulator for
  a very simple "assembly" language. TODO `Day 8 VOD on YouTube`\_.
+ *(227/168, 1/1)* TODO `Day 9 VOD on YouTube`\_.
+ *(1095/708, 5/4)* TODO `Day 10 VOD on YouTube`\_.
+ *(2173/3183, 5/7)* TODO `Day 11 VOD on YouTube`\_.
+ *(775/2405, 3/7)* TODO `Day 12 VOD on YouTube`\_.
+ *(573/5233, 2/10)* TODO `Day 13 VOD on YouTube`\_.
+ *(1982/1388, 8/5)* TODO `Day 14 VOD on YouTube`\_.
+ *(1055/464, 5/2)* TODO `Day 15 VOD on YouTube`\_.
+ *(399/254, 2/1)* TODO `Day 16 VOD on YouTube`\_.
+ *(2348/2006, 5/5)* TODO `Day 17 VOD on YouTube`\_.
+ *(1225/1219, 2/2)* TODO `Day 18 VOD on YouTube`\_.
+ *(1931/4038, 5/4)* TODO `Day 19 VOD on YouTube`\_.
+ *(4269/1760, 8/4)* TODO `Day 20 VOD on YouTube`\_.
+ *(1489/1837, 6/5)* TODO `Day 21 VOD on YouTube`\_.
+ *(439/573, 3/4)* TODO `Day 22 VOD on YouTube`\_.
+ *(613/1792, 2/4)* TODO `Day 23 VOD on YouTube`\_.
+ *(1084/1049, 5/3)* TODO `Day 24 VOD on YouTube`\_.
+ *(3173/2555, 8/6)* TODO `Day 25 VOD on YouTube`\_.
...
.. \_Day 3 VOD on YouTube: https://youtu.be/D9XCB\_m-GuA
...
.. \_Day 16 VOD on YouTube: https://youtu.be/kG\_dMdgxU\_I
.. \_Day 17 VOD on YouTube: https://youtu.be/Mjd6CWwxHzw
.. \_Day 18 VOD on YouTube: https://youtu.be/LahmCoZCWOk
.. \_Day 19 VOD on YouTube: https://youtu.be/lo9huRNT\_7w
...
.. \_Day 25 VOD on YouTube: https://youtu.be/C1\_LIZC0SHU
