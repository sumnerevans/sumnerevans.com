...
#set document(
  ...
  extra: (
    ...
    tags: ("Typst", "Resume", "LaTeX", "LLM"),
    math: true,
    aliases: ("../my-resume-is-typst",),
  ),
)
#show: page-template

A few weeks ago, #link("https://typst.app/")[Typst] came back on my radar because
#link("https://www.youtube.com/@sylvanfranklin")[Sylvan Franklin]'s videos on the topic
came into my YouTube feed. In particular,
#link("https://www.youtube.com/watch?v=Bwo1oX4wapE")[_Rewriting my resume in Typst_] in
which he rewrites his resume from (\\LaTeX) to Typst piqued my interest. I have
maintained #link("https://github.com/sumnerevans/resume")[my resume] in (\\LaTeX)
...
#link("https://loqusion.github.io/typix/")[Typix]. It is automatically compiled by
GitHub Actions, and a PR is automatically created against my website to update
the resume linked from #link("https://sumnerevans.com../../portfolio/index.md")[my portfolio].
...
- *The Nix integration is great.* This is a testament to
  #link("https://loqusion.dev")[loqusion]'s work on Typix more than anything. Typix
...
- *Typst packages seem cool.* It seems like there's packages for lots of
  things on #link("https://typst.app/universe/")[Typst Universe], and defining a custom
  package seems more straightforward than in (\\LaTeX).
- *The #link("https://myriad-dreamin.github.io/tinymist/")[Tinymist LSP] is
...
(\\LaTeX) with the #link("https://ctan.org/pkg/beamer?lang=en")[Beamer package]
...
#link("https://sumnerevans.com../../portfolio/index.md#experience-adjunct-mines")[teaching Algorithms]
...
#link("https://github.com/neovim/nvim-lspconfig")[nvim-lspconfig] framework for
